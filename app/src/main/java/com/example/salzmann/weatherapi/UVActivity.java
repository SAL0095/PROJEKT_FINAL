...
public class UVActivity extends AppCompatActivity {
    ...
    private void loadPage() {
        if (((sPref.equals(ANY)) && (wifiConnected || mobileConnected))
            ...
            // AsyncTask subclass
            new UVActivity.DownloadJsonTask2(this).execute(URL + API_KEY + "&lat=" + lat.getText().toString() + "&lon=" + lon.getText().toString() + "&start=1498049953&end=1498481991");
            //openweathermap.org/data/2.5/uvi/history?lat=37.75&lon=-122.37&start=1498049953&end=1498481991&appid=b6907d289e10d714a6e88b30761fae22
        } else {
            showErrorPage();
            updateConnectedFlags();
        }
